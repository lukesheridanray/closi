...
CLOSI_PRIMARY = colors.HexColor("#6C63FF")
CLOSI_PRIMARY_LIGHT = colors.HexColor("#E8E7FF")
...
def _get_styles():
    ...
    styles.add(ParagraphStyle(
        "Brand", parent=styles["Title"], fontSize=24, textColor=CLOSI_PRIMARY,
    ...
    styles.add(ParagraphStyle(
        "GrandTotal", fontSize=13, textColor=CLOSI_PRIMARY, fontName="Helvetica-Bold",
    ))
    styles.add(ParagraphStyle(
        "GrandTotalValue", fontSize=13, textColor=CLOSI_PRIMARY, fontName="Helvetica-Bold",
        alignment=TA_RIGHT,
    ))
    styles.add(ParagraphStyle(
    ...
    styles.add(ParagraphStyle(
        "MonitoringText", fontSize=10, textColor=CLOSI_PRIMARY, fontName="Helvetica-Bold",
    ))
    return styles
...
def _build_line_items_table(headers: list[str], rows: list[list[str]]):
    ...
    style_commands = [
        # Header row
        ("BACKGROUND", (0, 0), (-1, 0), CLOSI_PRIMARY),
        ...
        ("ALIGN", (0, 0), (0, -1), "LEFT"),
        # Grid
        ("LINEBELOW", (0, 0), (-1, 0), 1, CLOSI_PRIMARY),
...
def generate_quote_pdf(
    ...
    elements.append(HRFlowable(width="100%", thickness=2, color=CLOSI_PRIMARY, spaceAfter=16, spaceBefore=8))
    ...
    totals_table.setStyle(TableStyle([
        ("ALIGN", (1, 0), (1, -1), "RIGHT"),
        ("LINEABOVE", (0, -1), (-1, -1), 2, CLOSI_PRIMARY),
    ...
    elements.append(Paragraph(f"Generated by CLOSI CRM &bull; {org_name}", styles["Footer"]))
...
def generate_invoice_pdf(
    ...
    totals_table.setStyle(TableStyle([
        ("ALIGN", (1, 0), (1, -1), "RIGHT"),
        ("LINEABOVE", (0, 2), (-1, 2), 2, CLOSI_PRIMARY),
        ("TOPPADDING", (0, 0), (-1, -1), 4),
        ("BOTTOMPADDING", (0, 0), (-1, -1), 4),
    ]))
    elements.append(totals_table)
